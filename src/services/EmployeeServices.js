...
export const listEmployees = () => axios.get(`${REST_API_BASE_URL}/all-employee`);

export const addEmployee = (employee) => axios.post(`${REST_API_BASE_URL}/add-employee`, employee);
